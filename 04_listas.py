...
my_list=[27,35,62,52,30,30,17]      
                                        #*si utilizamos solamente los parentesis se convierte en un tuple ejemplo: my_list=(27,35,62,52,30,30,17) es una tupla no una lista
...
del my_list[2]                          #*del elimina el elemento en el indice indicado sin guardarlo 
print(my_list)

my_new_list=my_list.copy()              #.copy copia los elementos de una lista

my_list.clear()                         #.clear elimina los elmenentos de una lista, pero no la lista
